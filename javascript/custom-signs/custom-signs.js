...
export function costOf(sign, currency) {
  const BASE = 20;
  const PRICE_PER_CHAR = 2;
  const priceForSign = (sign.length * PRICE_PER_CHAR )+ BASE
  return `Your sign costs ${priceForSign.toFixed(2)} ${currency}.`;
}
